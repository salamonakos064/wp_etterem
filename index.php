...
<main>
  ...
  <?php
    ...
    echo "<h1 class=\" col-12 d-flex justify-content-center\">Welcome,$user </h1>";
    
    }
    else{
      echo "<h1 class=\" col-12 d-flex  justify-content-center \">Welcome, Guest</h1>";
    ...
    if($_GET["p"]==2)
    {
      echo "Check your email to activate your password";
    }
    if($_GET["p"]==4)
    {
      echo "Token expired";
